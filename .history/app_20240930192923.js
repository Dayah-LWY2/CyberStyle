...
app.get('/purchased', ensureLoggedInAndExists, async (req, res) => {
    ...
    res.render('purchased', { title: 'Purchased Products', purchases: sortedPurchases, filter: none });
});
...
app.get('/delivered', ensureLoggedInAndExists, async (req, res) => {
    ...
    res.render('delivered', { title: 'Delivered Products', deliveredItems: sortedDelivered, filter: none });
});
