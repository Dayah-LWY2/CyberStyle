...
app.post('/signup', async (req, res) => {
    ...
    if (existingUsername) {
        ...
        errorMessage = 'Phone number must start with "01" and be followed by at least 8 digits.';
        return res.redirect('/signup?errorMessage=Phone number must start with "01" and be followed by at least 8 digits.');
    }
