...
sizeSelect.addEventListener('change', function () {
    ...
    if (stockData[selectedSize]) {
        ...
        addToCartBtn.disabled = true; // Fixed this line
        buyNowBtn.disabled = true; // Fixed this line
    }
});
...
editBtn.addEventListener('click', () => {
    ...
    // Disable stock-related buttons when editing profile
    increaseBtn.disabled = true;
    decreaseBtn.disabled = true;
...
saveBtn.addEventListener('click', () => {
    ...
    .then(data => {
        if (data.success) {
            ...
            // Re-enable stock-related buttons after saving
            increaseBtn.disabled = false;
