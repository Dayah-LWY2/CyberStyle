...
function updateTotal() {
    ...
    // Calculate how much discount can be applied based on rewards points
    const redeemableDiscount = Math.floor(rewardsPoints / 100); // Each 100 points gives RM1
    const discount = useRewardsCheckbox.checked ? Math.min(redeemableDiscount, originalTotal) : 0; 
