...
function updateTotal() {
    ...
    const cartItems = document.querySelectorAll('.cart-item'); // For checkout

    let totalAmount = originalTotal;
    const rewardsPoints = parseFloat(rewardsPointsElement.innerText); // Get available rewards points

    // If on checkout, recalculate the total based on cart items
    ...
    // Calculate how much discount can be applied based on rewards points (100 points = RM1)
