...
function updateTotal() {
    ...
    const discount = useRewardsCheckbox.checked ? Math.min(rewardsPoints, originalTotal - 30) : 0; // Ensure it doesn't reduce total below $30
    const updatedTotal = originalTotal - discount; // Update total after discount

    // Ensure the minimum total is $30
    const finalTotal = Math.max(updatedTotal, 30); // Set minimum to $30
