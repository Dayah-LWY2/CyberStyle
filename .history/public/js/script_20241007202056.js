...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const inputs = [usernameInput, emailInput, phoneInput, genderInput, dobInput, addressInput];
    ...
    editBtn.addEventListener('click', () => {
        console.log("Edit button clicked"); // Ensure this is logged when the button is clicked

        inputs.forEach(input => {
            input.disabled = false;  // Enable each input
            console.log(input.id + ' is enabled');  // Log the action
        });
    ...
    // Save functionality (this part is optional and can be tested later)
