...
function toggleAnswer(questionElement) {
    ...
    faqItems.forEach(item => {
      ...
      if (item !== questionElement.parentElement) {
    ...
    const isVisible = answerElement.classList.contains('open');
    ...
    if (isVisible) {
      ...
      answerElement.style.maxHeight = answerElement.scrollHeight + 'px'; // Smooth height transition
