...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const originalTotal = parseFloat(totalAmountElement.innerText); // Get the original total amount

    useRewardsCheckbox.addEventListener('change', () => {
        let discount = Math.min(rewardsPoints, originalTotal); // Calculate discount based on rewards
        let updatedTotal = originalTotal - discount; // Update total after discount
