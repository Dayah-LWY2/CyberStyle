...
function updateTotal() {
    ...
    // Calculate how many points the user will earn (always shown)
    const pointsEarned = Math.floor(totalAmount * 1);
    ...
    if (useRewardsCheckbox.checked) {
        const pointsToDeduct = Math.min(rewardsPoints, Math.floor(totalAmount)); // Max points usable
        const rmDeducted = pointsToDeduct * 0.01; // RM deducted
