...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const thumbnails = document.querySelectorAll(".thumbnail"); // Assuming .thumbnail class for thumbnails
    const mainImage = document.querySelector(".main-image"); // Assuming .main-image class for the main image
    ...
    setInterval(updateMainImage, 3000); // Change every 3 seconds
});
