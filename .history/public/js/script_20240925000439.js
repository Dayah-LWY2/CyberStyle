...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var sizeSelect = document.getElementById('size-select');
        var initialSize = sizeSelect.value;
        var stockData = JSON.parse(document.getElementById('stock-data').value);
        var availableStockDisplay = document.getElementById('available-stock');

        // Set the initial available stock
        availableStockDisplay.innerText = stockData[initialSize];

        // Update the available stock display on size change
        sizeSelect.addEventListener('change', function() {
            var selectedSize = this.value;
            availableStockDisplay.innerText = stockData[selectedSize];
        });
