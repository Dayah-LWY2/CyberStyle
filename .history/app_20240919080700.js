...
app.get('/search', async (req, res) => {
    ...
    const sort = req.query.sort;  // Cheapest, Most expensive, etc.
    ...
    if (sort === 'cheapest') {
        ...
        filteredProducts.sort((a, b) => b.popularity - a.popularity); // Assuming you have a popularity field
    }
...
app.get('/search-results', (req, res) => res.render('search-results', { title: 'Search-Results', query, products: filteredProducts, pages: filteredPages }));
