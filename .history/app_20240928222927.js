...
app.get('/purchased', ensureLoggedInAndExists, async (req, res) => {
    try {
        ...
        if (!user || !user.purchased) {
            return res.render('purchased', { purchasedItems: [], deliveredProducts: [] }); // Handle no purchases
        }
        ...
        // You need to define deliveredProducts based on your logic
        const deliveredProducts = user.deliveredProducts || []; // Example, replace with your actual logic

        res.render('purchased', { purchasedItems, deliveredProducts });
    } catch (error) {
