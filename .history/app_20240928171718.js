...
app.post('/process-checkout', ensureLoggedInAndExists, async (req, res) => {
    try {
        ...
        // Log the total spent before applying rewards
        console.log('Total Spent Before Rewards:', totalSpentBeforeRewards);

        // Calculate rewards points earned based on the total spent before rewards
        const rewardsPointsEarned = Math.floor(totalSpentBeforeRewards); // Earn 1 point for every RM1 spent
