...
app.post('/process-checkout', ensureLoggedInAndExists, async (req, res) => {
    try {
        ...
        for (const item of cart) {
            // ... [Your existing code to calculate totalSpent] ...
        }
        ...
        let totalSpentBeforeRewards = totalSpent; // Use let instead of const
        ...
        // Calculate rewards points earned (1 point per RM spent including shipping)
